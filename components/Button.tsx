...
const getColorClasses = (color: string): string => {
  if (color === 'secondary') {
    return 'text-black dark:text-gray-100 bg-gray-100 dark:bg-gray-900 hover:bg-gray-200 dark:hover:bg-gray-800 focus:ring-gray-500 dark:focus:ring-gray-400 focus:ring-opacity-30 dark:focus:ring-opacity-30';
  }
